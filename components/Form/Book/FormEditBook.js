...
const EditBookWithFormik = withFormik({
  ...
  return { Ten:bookEdit.Ten, NamXB: bookEdit.NamXB,Gia: bookEdit.Gia,SoLgHienTai:bookEdit.SoLgHienTai,SoLgDauSach:bookEdit.SoLgDauSach,MaTacGia:bookEdit.MaTacGia,MaNXB:bookEdit.MaNXB,MaKeSach:bookEdit.MaKeSach,MaTheLoai:bookEdit.MaTheLoai,AnhSach:bookEdit.AnhSach,NoiDung:bookEdit.NoiDung, } },
